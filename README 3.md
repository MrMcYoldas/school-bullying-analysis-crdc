...
# 🏫 School Bullying Reporting Analysis Dashboard

### From CRDC school-level records to transparent review signals and targeted follow-up

![Build Status](https://img.shields.io/badge/Analytics_Build-Complete-1557C0?style=for-the-badge)
![Documentation](https://img.shields.io/badge/Documentation-Final_Review-3C82D4?style=for-the-badge)
![CRDC](https://img.shields.io/badge/CRDC-2021--22-0B2D63?style=for-the-badge)
![Python](https://img.shields.io/badge/Python-ETL-3C82D4?style=for-the-badge&logo=python&logoColor=white)
![PostgreSQL](https://img.shields.io/badge/PostgreSQL-Analytics-336791?style=for-the-badge&logo=postgresql&logoColor=white)
![Tableau](https://img.shields.io/badge/Tableau-Dashboard-1557C0?style=for-the-badge)

**A metric-driven decision-support and quality-assurance project using the Civil Rights Data Collection (CRDC) 2021–22.**

*Identify reporting concentrations · Examine category and demographic context · Prioritize deeper review*
...
<!-- IMAGE 1: Place the Data Architecture graphic here. Suggested filename: documentation/Images/data-architecture-metric-construction.png -->
<!-- Markdown: ![Figure 1. Data Architecture and Metric Construction](documentation/Images/data-architecture-metric-construction.png) -->
...
<!-- IMAGE 2: Place the Classification Logic graphic here. Suggested filename: documentation/Images/classification-ranking-action-logic.png -->
<!-- Markdown: ![Figure 2. Classification, Ranking and Action Logic](documentation/Images/classification-ranking-action-logic.png) -->
...
<!-- IMAGE 3: Place the Data Dictionary graphic here. Suggested filename: documentation/Images/dashboard-data-dictionary-kpi-reference.png -->
<!-- Markdown: ![Figure 3. Dashboard Data Dictionary and KPI Reference](documentation/Images/dashboard-data-dictionary-kpi-reference.png) -->
