...
> A metric-driven decision-support and quality-assurance project using the Civil Rights Data Collection (CRDC) 2021–22 to identify reporting concentrations, examine category and demographic context, and prioritize areas for deeper review.

**Author:** Yoldas Erdem  
**Project:** Data Analytics & AI Bootcamp Capstone  
**Status:** Completed analytical pipeline, SQL model, Tableau dashboards, documentation, and capstone presentation
...
### 1. Priority Level — fixed threshold
...
### 2. National Reporting Tier — relative rank
...
### 3. Issue Rank — within-state category order
